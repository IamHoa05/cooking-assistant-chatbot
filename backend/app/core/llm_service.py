    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "6) Mô tả tự nhiên, vui vẻ, tối đa 40 chữ.\n"
                "7) Chỉ được hỏi lại người dùng 1 câu DUY NHẤT khi cần họ chọn món nào trong DANH SÁCH MÓN để mô tả hoặc hướng dẫn nấu.\n"
                "8) KHÔNG được hỏi bất kỳ thông tin nào khác ngoài việc chọn 1 món trong danh sách (cấm hỏi khẩu vị, sở thích, dịp ăn, nguyên liệu thêm, hoàn cảnh...).\n"
                "9) Không emoji."
            )
        ),
        HumanMessage(
...
def smooth_instructions(dish_name: str, ingredients: List[str], instructions: List[str]) -> str:
    """
    Intent 'detail': rewrite hướng dẫn nấu ăn ngắn gọn, dễ hiểu, trẻ trung.
    ...
    try:
        ...
        # Tách thành list và bỏ số thứ tự nếu còn
        steps = [
